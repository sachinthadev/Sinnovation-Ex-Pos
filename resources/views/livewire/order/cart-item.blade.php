...
<tr class="odd:bg-white even:bg-gray-100">
    <td class="px-2 py-1 border-r dark:text-gray-800 min-w-[200px] max-w-[400px] whitespace-normal break-words">{{ $itemName }}</td>
    <td class="px-2 py-1 border-r text-center dark:text-gray-800">{{ number_format($itemPrice, 2) }}</td>
    ...
    <td class="px-2 py-1 text-center">{{ number_format($itemTotal, 2, '.', '') }}</td>
</tr>
